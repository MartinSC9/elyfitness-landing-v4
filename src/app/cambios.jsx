...
const CAMBIOS_ULTRA = [
  ...
  },
  {
    ...
    img: '/cambios/elena-barquilla.png',
  },
  {
    ...
    img: '/cambios/cristina-suarez.png',
  },
  {
  ...
  },
  {
    ...
    img: '/cambios/alvaro-martinez.png',
  },
  {
  ...
  },
  {
    ...
    img: '/cambios/ruben-mallenco.png',
  },
  {
  ...
  },
  {
    ...
    img: '/cambios/natalia-sastre.png',
  },
  {
    ...
    img: '/cambios/carmen-castillo.png',
  },
  {
...
const CAMBIOS_ANUAL = [
  {
    ...
    img: '/cambios/jessica-moreno.png',
  },
  {
  ...
  return (
    <div className="min-h-screen bg-cream">
            ...
            {FILTERS.map(f => {
              ...
              return (
                <button
                  ...
                  className={`inline-flex items-center gap-2 px-5 py-2.5 rounded-full text-sm font-bold uppercase transition-all ${
      ...
      <div className="bg-dark py-12 text-center">
        <h2 className="text-2xl sm:text-3xl font-black text-white uppercase mb-3">Tú puedes ser el <span className="text-gradient">siguiente</span></h2>
        <p className="text-white/35 text-sm mb-6">Empieza tu cambio conmigo. Elige el plan que mejor se adapte a ti.</p>
          ...
          <>
            ...
            <motion.div initial={{ opacity: 0, scale: 0.95, y: 20 }} animate={{ opacity: 1, scale: 1, y: 0 }} exit={{ opacity: 0, scale: 0.95 }} transition={{ type: 'spring', damping: 25 }} className="fixed inset-0 z-50 flex items-center justify-center p-4 pointer-events-none">
              <div className="bg-white rounded-2xl shadow-2xl max-w-lg w-full pointer-events-auto relative overflow-hidden max-h-[90vh] overflow-y-auto">
                ...
                <div className="relative overflow-hidden">
                  <img src={selected.img} alt={`Transformación ${selected.name}`} className="w-full aspect-square object-cover" />
                </div>
